# CASE FACTS — Confirmed Information
## Case 24-32819, District of Minnesota
...
| Detail | Value | Source |
|--------|-------|--------|
| Case Number | 24-32819 | User provided |
| Court | U.S. Bankruptcy Court, District of Minnesota | User provided |
| Chapter | 13 | User provided |
| Filing Year | 2024 | User provided |
| Trustee | Gregory A. Burrell | User provided |
| Trustee Address | 100 S. Fifth St, Suite 480, Minneapolis, MN 55402 | User provided / verified |
| Trustee Phone | (612) 338-7591 | User provided / verified |
| Trustee Email | general@ch13mn.com | Web research |
| Trustee Website | ch13mn.com | Web research |
| Debtor Portal | trustee13.com/login.aspx?trustee=GABMN | Web research |
| Attorney | Walker & Walker Law Offices, PLLC | User provided |
| Attorney Website | bankruptcytruth.com | Web research |
| Second Attorney | EXISTS — identity/role unknown | User mentioned "both my attorneys" |
| Wife on Bankruptcy | NO — non-filing spouse | User confirmed |
| Wife's Death Reported to Attorneys | YES | User confirmed |
...
### Kyle Waid (Debtor)
- DOB: 05/03/1985 (age 40)
- SSN: 363-02-4320 (from tax returns)
- Occupation: Software Engineer
- Current Employer: Golf Stix DBA 2nd Swing (started 2025)
- Current Salary: $145,000
- Phone: 612-518-7673
- Address: 3922 Boston Circle, Eagan, MN 55123

### Hillary Shippy/Waid (Deceased Non-Filing Spouse)
- DOB: 07/23/1982
- SSN: 374-02-7730 (from tax returns)
- Date of Death: March 2026 (approximate — user said "just last month" on April 11, 2026)
- Occupation: Homemaker (listed on all tax returns 2021-2023)
- Employment History: No earned income on any return 2021-2023
- Death Certificate: Not yet obtained

### Children (All Under 18)
| Name | DOB | Age (2026) | Relationship | SSN |
|------|-----|------------|-------------|-----|
| Isla Waid | 01/08/2011 | 15 | Daughter | 468-57-7829 |
| Owen Waid | 01/31/2013 | 13 | Son | 143-87-0105 |
| Eliza Waid | 02/12/2015 | 11 | Daughter | 668-39-0994 |
...
### Current (2025-2026)
- Employer: Golf Stix DBA 2nd Swing
- Salary: $145,000/year
- Started: 2025
- Wife's income: $0 (homemaker, now deceased)

### Tax Return History
| Year | W-2 Wages | Schedule C Net | Retirement Dist | Total AGI |
|------|-----------|---------------|----------------|-----------|
| 2021 | $142,241 | $6,600 | $0 | $148,814 |
| 2022 | $150,943 | $75,023 | $0 | $225,032 |
| 2023 | $156,827 | $1,000 | $14,252 (taxable) | $172,065 |
| 2025+ | $145,000 | $0 (assumed) | Unknown | ~$145,000 |

### Employment History (From W-2s)
| Employer | 2021 | 2022 | 2023 | Notes |
|----------|------|------|------|-------|
| Decks Direct Inc/LLC | $129,163 | $93,960 | $90,118 | Present all 3 years, declining |
| Zastro LLC | 1099 ($8,270) | $55,688 (W-2) | $66,709 (W-2) | Transitioned from 1099 to W-2 |
| Frank Recruitment Group | $13,078 | — | — | 2021 only |
| Fridge Filters Inc | 1099 ($4,623) | $1,295 (W-2) | — | Small amounts |
| 2nd Swing (Golf Stix DBA) | — | — | — | Current employer, started 2025 |

### Self-Employment / Consulting
- Business: Software Consulting, NAICS 541511
- LLC: Gekko Tek LLC (registered for 2022, not dissolved or continued)
- 2021: Sole prop, $11,223 gross / $6,600 net (3 clients on 1099-NEC)
- 2022: Gekko Tek LLC, $81,705 gross / $75,023 net (only $1,200 on 1099-NEC)
- 2023: Gekko Tek LLC, $1,000 gross / $1,000 net (1 client — Peace Coffee PBC)
- Status: Appears dormant/inactive as of 2023
...
### Returns Filed
- All three years (2021, 2022, 2023) filed simultaneously on **09/27/2024**
- Preparer: Nina Lyakh, Preferred Accountability Tax Services
- PTIN: P01772608
- Address: 1715 Yankee Doodle Rd Suite 110, Eagan, MN 55121
- Firm EIN: 99-1044387
- Total fee invoiced: $680 ($240 + $260 + $180)
- User stated he paid $500

### Tax Results
| Year | Fed Result | State Result | Net | Late? |
|------|-----------|-------------|-----|-------|
| 2021 | Refund $12,206 | Refund $2,787 | +$14,993 | Yes (~2.5 years) |
| 2022 | **Owed $7,585** | **Owed $3,582** | **-$11,167** | Yes (~1.5 years) |
| 2023 | Refund $2,540 | Refund $2,341 | +$4,881 | Yes (~5 months) |
| **Net across all 3** | | | **+$8,707** | |

### Tax Complications
- 2022 penalties and interest on $11,167 owed (late filing + late payment) could add $3,000-$4,000+
- IRS will likely offset 2021 refund against 2022 balance automatically
- After offsets and penalties, net benefit may be close to zero or still owed
- Unpaid 2022 taxes may be a priority debt in the bankruptcy

---

## 5. RETIREMENT ACCOUNT ACTIVITY

### Known Distributions (From Tax Returns)
| Year | Source | Type | Gross | Taxable | Notes |
|------|--------|------|-------|---------|-------|
| 2022 | Unknown | Rollover | $1,607 | $0 | Non-taxable rollover |
| 2023 | Ascensus Trust Co | Early dist (Code 1) | $1,570 | $1,570 | 10% penalty applies |
| 2023 | State Street Retiree | Rollover (Code G) | $1,005 | $0 | Non-taxable |
| 2023 | State Street Retiree | Early dist (Code 1) | $12,682 | $12,682 | 10% penalty applies |
| **Total taxable early distributions** | | | | **$14,252** | |

### User Statements About 401(k)
- User confirmed he has been "borrowing from my 401k and hardship withdraw to stay afloat"
- Total amount of loans/withdrawals during Ch.13 unknown — need statements
- 401(k) current balance unknown
- Whether court approval was obtained for any of these is unknown

### Tax Cost of 2023 Withdrawals
- $14,252 taxable at ~22% fed + ~7% MN + 10% penalty = ~39%
- Estimated tax/penalty cost: ~$5,558
- Net usable from $14,252 withdrawn: ~$8,694
- **Destroyed $14,252 in retirement savings to get ~$8,694 in hand**

---

## 6. MEANS TEST POSITION

| Item | Value |
|------|-------|
| Current salary | $145,000 |
| MN median, household of 4 (current, Nov 2025) | $146,039 |
| MN median, household of 4 (Nov 2024) | $140,800 |
| MN median, household of 4 (pre-Nov 2024, when filed) | Higher than $140,800 |
| **Status** | **BELOW MEDIAN** |

### Implications of Below-Median Status
- 3-year plan commitment period possible (not locked into 5 years)
- Disposable income based on ACTUAL expenses (not IRS means test formula)
- More flexibility in deductible expenses
- Less aggressive court scrutiny

---

## 7. WHAT WE DON'T KNOW YET

See OPEN_QUESTIONS.md for the full list. Key unknowns:
- Monthly plan payment amount
- What debts are in the Chapter 13 (mortgage? cars? credit cards? taxes?)
- Whether there's a house/mortgage and its status
- Life insurance on wife (existence, amount, beneficiary)
- Wife's work history before 2021 (SS survivor benefit eligibility)
- 401(k) current balance and full withdrawal/loan history during Ch.13
