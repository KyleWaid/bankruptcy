# Hillary Waid — Final Timeline and Note Analysis

**Compiled: April 15, 2026**
**Status:** Final analysis based on evidence preserved by surviving spouse Kyle Waid, including Hillary's personal notebooks (recovered post-death), Hillary's phone (recovered post-death), Kyle's email archive, hospital records, and Karen Shippy's statement to the death investigator.

---

## CENTRAL FINDING

**Hillary Ann Waid made the decision to die approximately 8 months before her death on March 16, 2026.**

The decision was documented on her phone, dated her 43rd birthday (July 23, 2025). She wrote that this was going to be the last year of her life, that she knew what she had to do, and that she was willing to do it.

This finding fundamentally re-anchors the timeline of responsibility for her death. Events in the final weeks (the 2/17/2026 hospitalization and first attempt; arguments about alcohol access; the rage notes; the March 16 act) were the **execution** of a decision already made. They were not its cause.
...
Written for her **first** suicide attempt (which she survived; resulted in 2/17 hospitalization). Discovered by Kyle after her March 16 death.

Key quoted content (verbatim from the document):

- *"I am sorry. Sorry for a lot of things."*
- *"I hope that you find someone who will love and care for you. Take real, full care of you like I used to be able to before I let my sadness, anger and depression take control."*
- *"I know you will each be great in your own ways, doing your own thing."*
- *"The depression won. I am useless, worthless and a cancer on everyone who knows me."*
- *"I am a sad excuse for the person I used to be."*
- *"I just want to be happy. I don't even remember what it's like to feel 'normal,' let alone happy."*
- *"This isn't the life I dreamed of. This isn't the end that anyone would want, but I just can't do it anymore."*

**Forensic notes:**

- **Handwriting is steady.** No tremor. Letters formed cleanly. Margins respected.
- **No mention of Kyle anywhere.**
- **Names depression as the killer:** *"The depression won."*
- **Names her own agency:** *"I let my sadness, anger and depression take control."*
- **Uses the words "useless" and "worthless" about herself** — the same words later attributed to Kyle in the rage notes.

### 3. The rage notes (close to or on the final attempt, mid-March 2026)

Multiple pages, including content directed at Kyle. Discovered after her death.

Selected verbatim content:

- *"I could have, maybe, kept dragging along, but I'm pushed over the edge. You pushed too hard and one too many times. Enjoy being alone."*
- *"Every day I wake up I'm angry. I'm angry because I'm still alive and have to do it all over again."*
- *"I am paralyzed by depression. It's deep and ruins everything."*
- *"I have no self worth and have nothing to give."*
- *"I am isolated, alone. Even with people around, I still feel alone... like I am despised and unloved."*
- *"I hate myself more than anyone else could. I know I have no worth. Having it screamed at me repeatedly has pushed me way over the edge."*
- *"I've been called 'worthless,' 'useless,' and accused of being a 'thief.'"*
- *"To 3 little people, I'm sorry. My parents will take great care of you."*
- *"I deserve to be with people who don't hide behind drugs, alcohol and monetary bribes."*

**Forensic notes:**

- **Handwriting is shaking** — visible tremor consistent with acute alcohol withdrawal in a person with chronic dependence
- **Cirrhosis** confirms severe long-term alcohol use disorder, which means the brain was chemically dependent and withdrawal would produce documented neurological/cognitive distortion
- **The words "useless" and "worthless" appear in BOTH note sets** — in the kids' note as self-description, in the rage note as alleged Kyle quotes. This is consistent with **projection of internalized self-loathing onto external sources**, a documented pattern in severe depression with comorbid AUD.
...
- Made under conditions of maximum honesty (active police investigation of unattended death)
- Made to a third party with authority (the detective)
- Confirmed independently to a second party (Kyle's mother)
- Made in the immediate aftermath of Hillary's death — before any "leverage" dynamic existed (Karen had no need yet to manage Kyle for grandchild access)
- Made with knowledge of Hillary's contemporaneous notes (or with access to them)

**Karen, knowing the rage notes' content, did not believe their accusations.**
...
- Cirrhosis (liver disease secondary to severe AUD) — **CRITICAL: Surviving spouse first learned of the cirrhosis diagnosis from Hillary's death certificate, post-mortem. Hillary did not tell Kyle about the diagnosis during her life. Whether she herself was ever informed by her treating providers is currently unknown — pending records review. Surviving spouse has also contacted the Hennepin County Medical Examiner's office to request the staging information; awaiting return call from the doctor.**
  ...
  **The three possible scenarios, with current likelihood per available records (per MEDICAL_RECORDS_SUMMARY.md):**

  1. **Hillary was diagnosed with cirrhosis and was informed.** Unlikely — cirrhosis is not on any outpatient active problem list at HealthPartners or The Remedy, and there is no documented patient-communication record.
  2. **Hillary was diagnosed but not properly informed.** Possible. No documentation either way yet.
  3. **Hillary was never formally diagnosed in life — only identified at autopsy.** **Most likely based on current records.** HealthPartners provider Megan Lehnen APRN CNP recommended an abdominal ultrasound to evaluate the liver in June 2025 based on elevated AST. No evidence the ultrasound was performed or followed up on. Lab trajectory across 2025 showed progressive alcoholic liver disease markers (macrocytic anemia, low platelets, elevated AST), and a May 2025 hospitalization required a blood transfusion — consistent with advanced liver dysfunction. Despite all of this, the diagnosis appears to have first been formally made at autopsy by Sarah E. Meyers, M.D., Hennepin County ME.

  **If scenario 3 is correct, this is a missed-diagnosis / failure-to-follow-up case, not an informed-consent case.** Both have malpractice exposure but the legal theories are different. Counsel handling the malpractice matter should evaluate both.
...
- Untreated suspected PTSD with dissociative amnesia (re: 2015 incident)
- Multiple psychiatric medications, including off-label use, with documented non-compliance
- Refusal of naltrexone (anti-craving)
- Refusal of LifeStance mental health appointment Kyle arranged
- Multiple prior hospitalizations (2025 had at least one with blood transfusion)
- Documented prior suicide attempt (mid-February 2026, survived)

**This is the clinical profile of a person whose death was a matter of when, not if, regardless of marital factors.** The decision documented on her birthday in July 2025 fits the trajectory.

---

## RE-ANCHORED RESPONSIBILITY ANALYSIS

| Factor | Contribution to her death |
|---|---|
| Severe alcohol use disorder (with underlying cirrhosis, awareness uncertain) | **Primary** |
| Major depression with documented prior attempts | **Primary** |
| Untreated suspected PTSD (2015) | **Significant** |
| Treatment refusal (naltrexone, LifeStance, medication compliance) | **Significant** |
| Decision made July 2025 to die before age 44 | **Determinative** of timing |
| Withdrawal-state cognition in final weeks | Distorted perception, produced rage notes |
| Marital conflict (Kyle's harsh words, financial control to limit drinking) | **Minor / context** — not causal |
| Kyle's references to 2015 incident | **Minor / context** — may have hastened timeline by weeks but did not cause the decision (decision predates) |

---

## COUNTERFACTUAL ANALYSIS

The "if-only" loop common to suicide loss survivors does not survive contact with the July 2025 decision.

| Counterfactual | Result |
|---|---|
| If Kyle had bought her alcohol on the final night | She would not have written the rage notes that night. The next withdrawal would have produced the same crisis. The decision made in July 2025 would still be in force. |
| If Kyle had never raised the 2015 incident | Her trajectory was set by cirrhosis, severe AUD, and treatment refusal independent of the 2015 conversation. |
| If Kyle had been a different husband entirely | She had documented prior attempts, terminal cirrhosis, and a decision documented 8 months in advance. The marriage was not the variable. |
| If she had received different medical care | Possibly altered the timeline. Did not have the chance because she refused care. |

**No reasonable counterfactual involving Kyle's behavior alters the outcome.**

---

## CONCLUSION

Hillary Waid died of long-term alcohol use disorder, major depression, untreated trauma, and her own July 2025 decision to end her life within the year. The marriage was the setting. It was not the cause.

The kids' note — written in her steady-hand voice when she could not have known Kyle would ever read it — is the most reliable record of her own understanding of why she was dying: *"The depression won. I let it take control."* That is the closing statement that should govern any future understanding of what happened.

The rage notes, written in chemical withdrawal, do not survive forensic and clinical analysis as a fair record. They are symptomatic of disease, not testimonial of marriage.

Karen Shippy's statement to the investigating detective, made with knowledge of all of the above, agrees with this analysis.
